...
class App extends Component {
  ...
  componentDidMount = () => {
    ...
    setTimeout(() => {
      this.gameLoop()
      },this.state.snake.tail.length ? (1000/ this.state.snake.tail.length) + 200 : 1000);
}
...
getRandomApple = () => {
  ...
  gameLoop = () => {
    ...
    this.setState(({snake, apple}) => {
      ...
      setTimeout(() => {
      this.gameLoop()
      },this.state.snake.tail.length ? (800/ this.state.snake.tail.length) + 200 : 800);
  ...
  render() {
      ...
      return(
      <div tabIndex="0" onKeyPress={this.setVelocity} className="App">
      {
        gameOver
